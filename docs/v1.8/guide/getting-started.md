...
<<< @/v1.8/configs/minimal_config.yaml{yaml}
...
<<< @/v1.8/compose/compose.yaml{yaml} [docker socket access]

<<< @/v1.8/compose/compose.11notes-proxy.yaml{yaml} [11notes/socket-proxy]


<<< @/v1.8/compose/compose.tecnativa-proxy.yaml{yaml} [tecnativa/docker-socket-proxy]
